                    ...
                    <div className="h-full w-full flex flex-col max-w-3xl mx-auto mb-16 sm:px-0">
                        ...
                        <motion.div className={style1.diva} variants={some.fadeInUp} >
                            <div className="mt-8 grid gap-6" >
                                ...
                                <a href="www.bajram.fyi" rel="noopener" target="_blank" className="focus:outline-none transition duration-300 ease-in-out transform hover:scale-105 flex flex-col sm:flex-row text-center sm:text-left px-8 sm:px-6 py-6 rounded-md border border-gray-800 shadow flex flex-row max-w-2xl">
                                    <div
                                ...
                                <a href="https://github.com/bajramdev/MERN" rel="noopener" target="_blank" className="focus:outline-none transition duration-300 ease-in-out transform hover:scale-105 flex flex-col sm:flex-row text-center sm:text-left px-8 sm:px-6 py-6 rounded-md border border-gray-800 shadow flex flex-row max-w-2xl">
                                    <div
                                        className="flex items-center justify-center text-4xl w-full sm:w-1/12 mr-6 mb-4 sm:mb-0">
                                        <svg height={36} width={36} aria-hidden="true" focusable="false"
                                             data-prefix="fab" data-icon="MERN"
                                             className="svg-inline--fa fa-discord fa-w-14" role="img"
                                             viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                            <path fill="currentColor"
